...
import com.example.android.sunshine.app.wearable.WearableWrap;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private WearableWrap wearableWrap;

    public SunshineSyncAdapter(Context context, boolean autoInitialize) {
        super(context, autoInitialize);
        wearableWrap = new WearableWrap(context);
    }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    Log.w("ANNA", "I've downloaded weather info: " + low + "," + high + "," + weatherId);
                    wearableWrap.sendWeatherInfoToWearable(low, high, weatherId);
                }
            }
